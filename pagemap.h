...
unsigned int * get_ppn_for_pre_process(struct ssd_info *ssd,unsigned int *lsn ,unsigned int granularity, unsigned int command);
...
unsigned int get_ppn_for_gc(struct ssd_info *ssd, unsigned int granularity_num, unsigned int channel,unsigned int chip,unsigned int die,unsigned int plane);
int erase_operation(struct ssd_info* ssd, unsigned int granularity_num, unsigned int channel, unsigned int chip, unsigned int die, unsigned int plane, unsigned int block);
int erase_planes(struct ssd_info* ssd, unsigned int granularity_num, unsigned int channel, unsigned int chip, unsigned int die1, unsigned int plane1, unsigned int command);
...
int gc_for_channel(struct ssd_info *ssd, unsigned int granularity_num, unsigned int channel);
